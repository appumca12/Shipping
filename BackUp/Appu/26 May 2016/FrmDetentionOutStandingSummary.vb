...
Public Class FrmDetentionOutStandingSummary
    ...
    Private Sub PickupMovement()
        ...
        sDateMonthQry = "select Distinct(year(IssueTime)) as Y, month(IssueTime) as M From TB_Invoice where IssueTime between '" & dFrom.ToString("yyyy-MM-dd") & "' AND '" & dTo.ToString("yyyy-MM-dd") & "' order by Y,M"
        ...
        sqlYear = "select Distinct(year(IssueTime)) as Y From TB_Invoice where IssueTime between '" & dFrom.ToString("yyyy-MM-dd") & "' AND '" & dTo.ToString("yyyy-MM-dd") & "' order by Y"
        ...
        With Me.GridSummary.DisplayLayout.Bands(0)
            .HeaderVisible = True
            .Header.Activated = True
            .Header.Caption = "Detention Outstanding Summary:" & dFrom & "  To:" & dFrom
            .Header.Appearance.BackColor = Color.Maroon
            .Header.Appearance.ForeColor = Color.Yellow
            .Header.Appearance.FontData.Name = "Verdana"
            .Header.Appearance.FontData.Italic = Infragistics.Win.DefaultableBoolean.True
