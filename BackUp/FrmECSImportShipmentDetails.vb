...
Public Class FrmECSImportShipmentDetails
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Import Shipment Details" Then
            PickupMovement()
        End If
    ...
    'End Sub
    Private Sub FrmECSImportShipmentDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
