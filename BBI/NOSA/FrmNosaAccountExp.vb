...
Public Class FrmNosaAccountExp

    Private TB As New DataTable
    Private Ds As DataSet
    Private DPLine As UltraDropDown
    Private DPCharge As UltraDropDown
    Private DPCharge2 As UltraDropDown
    Private DPCharge3 As UltraDropDown

    Dim DPCharge4 As UltraDropDown
    Private Sub FrmNosaAccountExp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        RefreshData()
    End Sub
    ...
    Private Sub lStripButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lStripButtonSave.Click
        ...
        Sql = "INSERT INTO [Shipping].[dbo].[TB_NOSAAccountExp]" & _
           "([ID]" & _
           ",[ChargesCode]" & _
           ",[Description]" & _
           ",[Line]" & _
        ...
        Sql = "Update TB_NOSAAccountExp " & _
              "SET " & _
        ...
        Cmddel.CommandText = "Delete TB_NOSAAccountExp Where ID = @ID"
    ...
    Private Sub RefreshData()
        ...
        TableBySql("Select * From tb_NOSAAccountExp Order By Line", TBA, lResult)
        TableBySql("Select * From TB_NOSAAccountSubExp  ", TBB, lResult)
        TableBySql("Select * From TB_NOSPaidTaxTitleExp  ", TBTax, lResult)
        ...
        With DPCharge
            ...
            .DropDownWidth = 700
            .DisplayLayout.Bands(0).Columns("Meaning").Width = 500
            .DisplayLayout.Bands(0).Columns("StdCode").Width = 200
            .DisplayLayout.Bands(0).Columns("Meaning").SortIndicator = SortIndicator.Ascending
        ...
        With DPCharge3
            ...
            .DisplayMember = "Meaning"
            .ValueMember = "Code"
            .DisplayLayout.Bands(0).Columns("Code").Hidden = False
            With GridData.DisplayLayout.Bands(0)
    ...
    Private Sub SaveDetail()
        ...
        Sql = "INSERT INTO [Shipping].[dbo].[TB_NOSAAccountSubExp] " & _
           "([ID]" & _
           ",[PID]" & _
           ",[ChargesCode]" & _
           ",[Description]" & _
        ...
        CmdUpd.Connection = Cnn
        CmdUpd.CommandType = CommandType.Text
        Sql = "Update TB_NOSAAccountSubExp " & _
              "SET " & _
              " [PID] = @PID " & _
              ",[ChargesCode] = @ChargesCode " & _
              ",[Description] = @Description " & _
        ...
        Cmddel.Connection = Cnn
        Cmddel.CommandType = CommandType.Text
        Cmddel.CommandText = "Delete TB_NOSAAccountSubExp Where ID = @ID"
        Cmddel.Parameters.Add(New SqlParameter("@ID", SqlDbType.VarChar, 36))
    ...
    Private Sub SaveTaxDetail()
        ...
        Sql = "INSERT INTO [Shipping].[dbo].[TB_NOSPaidTaxTitleExp] " & _
           "([ID]" & _
           ",[PID]" & _
           ",[ChargesCode]" & _
           ",[Description]" & _
        ...
        CmdUpd.Connection = Cnn
        CmdUpd.CommandType = CommandType.Text
        Sql = "Update TB_NOSPaidTaxTitleExp " & _
              "SET " & _
              " [PID] = @PID " & _
              ",[ChargesCode] = @ChargesCode " & _
              ",[Description] = @Description " & _
        ...
        Cmddel.Connection = Cnn
        Cmddel.CommandType = CommandType.Text
        Cmddel.CommandText = "Delete TB_NOSPaidTaxTitleExp Where ID = @ID"
        Cmddel.Parameters.Add(New SqlParameter("@ID", SqlDbType.VarChar, 36))
