...
Public Class RptHeaderLogoLS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BBIShipping.RptHeaderLogoLS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHeaderLogoLS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHeaderLogoLS = New RptHeaderLogoLS
        rpt.Site = Me.Site
        Return rpt
    End Function
