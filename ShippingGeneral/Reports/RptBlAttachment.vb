...
Public Class RptBlAttachment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shipping.RptBlAttachment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBlAttachment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBlAttachment = New RptBlAttachment
        rpt.Site = Me.Site
        Return rpt
    End Function
