...
Public Class RptInwardDetention
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shipping.RptInwardDetention.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInwardDetention
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInwardDetention = New RptInwardDetention
        rpt.Site = Me.Site
        Return rpt
    End Function
