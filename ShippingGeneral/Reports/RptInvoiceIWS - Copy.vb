...
Public Class RptInvoiceIWS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shipping.RptInvoiceIWS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceIWS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceIWS = New RptInvoiceIWS
        rpt.Site = Me.Site
        Return rpt
    End Function
