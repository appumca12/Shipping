...
Public Class PCLRptExpLoadList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shipping.PCLRptExpLoadList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPCLRptExpLoadList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PCLRptExpLoadList = New PCLRptExpLoadList
        rpt.Site = Me.Site
        Return rpt
    End Function
