...
Public Class RptHedaerLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BBIShipping.RptHedaerLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHedaerLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHedaerLogo = New RptHedaerLogo
        rpt.Site = Me.Site
        Return rpt
    End Function
