...
Public Class OldRptBooking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BBIShipping.OldRptBooking.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_UseName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedOldRptBooking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OldRptBooking = New OldRptBooking
        rpt.Site = Me.Site
        Return rpt
    End Function
