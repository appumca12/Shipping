...
Public Class RptTranshipBL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BBIShipping.RptTranshipBL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ShowLine() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptTranshipBL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTranshipBL = New RptTranshipBL
        rpt.Site = Me.Site
        Return rpt
    End Function
