...
Public Class RptInvoiceOfficial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BBIShipping.RptInvoiceOfficial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceOfficial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceOfficial = New RptInvoiceOfficial
        rpt.Site = Me.Site
        Return rpt
    End Function
