...
Public Class UserClients
    ...
    Public ReadOnly Property ClientName() As String
        ...
        End Get
    End Property
    Private Sub UserClients_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Enter
        BackColor = My.Settings.EditTextBackColor
        ForeColor = My.Settings.EditTextForcolor
    End Sub

    Private Sub UserClients_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
    Private Sub UserClients_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LostFocus
    ...
    Private Sub UserClients_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MouseHover
        SetToolTip()
    End Sub
End Class
