...
Public Class UserBlsNames
    ...
    Public Sub SetDocument(ByVal Dr As DataRow)
        ...
        Me.CneeAdd.TextValue = IIf(IsDBNull(Dr("CneeAdd")), "", Dr("CneeAdd"))
    ...
    Public Sub getDocument(ByRef Dr As DataRow)
        ...
        With Dr
            ...
            Dr("CneeAdd") = Me.CneeAdd.TextValue
    ...
    Public ReadOnly Property Changed() As Boolean
        Get
            If Me.Shipper.Changed Or Me.Cnee.Changed Or Me.CneeAdd.Changed Or Me.Notify1.Changed Or Me.Notify2.Changed Or Me.Messers.Changed Or Me.Forwarder.Changed Then
                Return True
            Else
                Return False
            End If
