Public Class CLDPAStructure
    ...
    Partial Public Class BOL
        ...
        Public Function GenerateSegmentBOL() As String
            ...
            S &= Chr(34) & H_CONSIGNEECODE & Chr(34) & Chr(44)
            ...
            S &= Chr(34) & H_PACKAGES & Chr(34) & Chr(44)
            ...
            S &= Chr(34) & H_CARGOWEIGHTINKG & Chr(34) & Chr(44)
            S &= Chr(34) & H_GROSSWEIGHTINKG & Chr(34) & Chr(44)
    ...
    Partial Public Class CON
        ...
        Public Property H_COMMODITYCODE() As String
            ...
            End Set
        End Property
        Public Property H_CONSIGNMENTPACKAGES() As Decimal
            Get
        ...
        Public Function GenerateSegmentCON() As String
            ...
            s &= chr(34) & mid(H_COMMODITYCODE, 1, 10) & chr(34) & Chr(44)
            'S &= Chr(34) & Format(H_CONSIGNMENTPACKAGES, "000000000.00") & Chr(34) & Chr(44)
            S &= Chr(34) & H_CONSIGNMENTPACKAGES & Chr(34) & Chr(44)
            s &= chr(34) & mid(H_PACKAGETYPE, 1, 30) & chr(34) & Chr(44)
            s &= chr(34) & mid(H_PACKAGETYPECODE, 1, 3) & chr(34) & Chr(44)
            s &= chr(34) & format(H_NOOFPALLETS, "0000") & chr(34) & Chr(44)
            'S &= Chr(34) & H_CONSIGNMENTWEIGHTIN & Chr(34) & Chr(44)
            S &= Chr(34) & Format(H_CONSIGNMENTWEIGHTIN, ".0") & Chr(34) & Chr(44)
    ...
    Partial Public Class CTR
        ...
        Public Function GenerateSegmentCTR() As String
            ...
            's &= chr(34) & mid(H_CONTAINERNUMBER, 1, 10) & chr(34) & Chr(44)
