...
Public Class FrmLocationWiseReport

    Private Dm As DataManager
    Private Sub FrmLocationWiseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.CmbStatus.InitControl("OF", UserComboCode.ShowCoumn.StdCode)
    ...
    Private Sub ButtonRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonRefresh.Click
        ...
        With Cmd
            .CommandText = "SP_LocationWiseReport"
    ...
    Private Sub ShowInwardInvoice()
        ...
        For Each R In GridImport.Selected.Rows
            ...
            TableBySql("Select AccountA From Tb_Clients CL , TB_InwardBls Bls , TB_Invoice Inv Where Cl.ID = Bls.ClientID and Inv.BLID = BLs.ID and Inv.ID = '" & R.Cells("ID").Value.ToString & "'", TB, lResult)
            ...
            For Each dr As DataRowView In Dv
                ...
                End If
                dr("Account") = Account
                dr("InvoiceID") = R.Cells("ID").Value.ToString
                dr("ISOCE") = pValue
            Next
    ...
    Private Sub ShowOutwardinvoice()
        ...
        For Each R In GridInvExport.Selected.Rows
            ...
            DS = StoredProcedures.SP_RptExpInvoice(R.Cells("ID").Value.ToString)
            Dv = New DataView(DS.Tables(0), "", "Seq", DataViewRowState.CurrentRows)
    ...
    Private Sub FrmLocationWiseReport_ResizeEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ResizeEnd
