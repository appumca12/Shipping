...
Public Class FrmCustomerDemurageReport
    ...
    Private Sub PickupMovement()
        ...
        For Each Dr In TB.Rows
            ...
            DS = StoredProcedures.SP_InwardBlsByLineBlNo(Dr("Line"), Dr("BLNO"))
            ...
            DS = Dtn.CalDetentionInwardInvoice(Dr("BLNO"), BLID, False, 0)
    ...
    Private Function GenSummaryDetention_ori(ByVal DET As CLDetention, ByVal Ds As DataSet) As System.Data.DataTable
    ...
    Private Function GenSummaryDetention(ByVal DET As CLDetention, ByVal Ds As DataSet) As System.Data.DataTable
        ...
        If DET.FirstPaid + DET.FirstPaidUsd > 0 Then
            ...
            Dim TB1 As New System.Data.DataTable
            Dim TB3 As New System.Data.DataTable
        ...
        If PaidDet + PaidDetUsd > 0 Then
            ...
            Dim Cmd As New SqlCommand
            Dim Cnn As New SqlConnection(My.Settings.DSN)
            Dim tbtax As System.Data.DataTable
            Dim invdetntax As Double
            invdetntax = 0
            TableBySql("select [dbo].[FC_DetnTax]('" & Ds.Tables(0).Rows(0).Item("ID").ToString() & "') as taxamount", tbtax, lResult)
