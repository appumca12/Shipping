...
Public Class FrmAgentDemurageReport
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Agents Demurrage Report" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        Cmd = New SqlCommand("SP_AgentDemurageReport")
        Cnn = New SqlConnection(My.Settings.DSN)
        Cmd.CommandTimeout = 2000
        Cnn.Open()
        Cmd.CommandType = CommandType.StoredProcedure
        Cmd.Parameters.AddWithValue("@Client", Me.Agents.ClientID)
    ...
    'End Sub
    Private Sub FrmAgentDemurageReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
