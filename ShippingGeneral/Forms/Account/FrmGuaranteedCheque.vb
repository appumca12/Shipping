...
Public Class FrmGuaranteedCheque
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Guarantee Cheques Report" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        Cmd = New SqlCommand("SP_Guarantedcheques")
    ...
    'End Sub
    Private Sub FrmGuaranteedCheque_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
