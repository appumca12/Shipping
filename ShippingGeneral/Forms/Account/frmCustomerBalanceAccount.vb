...
Public Class frmCustomerBalanceAccount
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Customer Balance Account" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        Cmd = New SqlCommand("SP_CustomerBalanceAccount")
    ...
    'End Sub
    Private Sub frmCustomerBalanceAccount_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
