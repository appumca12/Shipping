...
Public Class frmChargewiseReport
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Charge Wise Report" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        If Me.SearchChgCode.Code = "" Then
            MsgBox("Please Select Charge Code!")
            Exit Sub
        End If
        ...
        Cmd = New SqlCommand("SP_ChargewiseReport2")
        ...
        Cmd.Parameters.AddWithValue("@ChargeCode", Me.SearchChgCode.Code)
    ...
    'End Sub
    Private Sub frmChargewiseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
