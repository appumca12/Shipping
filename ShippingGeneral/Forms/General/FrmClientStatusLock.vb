...
Public Class FrmClientStatusLock
    ...
    Private Sub btnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFind.Click
        ...
        sSql = "select Id, BLNo, LockStatus, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, (select top 1 lName from TB_Clients where id = (select top 1 clientid from tb_inwardbls where blno = BLNO)) as Client_Name from TB_LockStatus where BLNo = '" & Me.txtBLNumber.Text.ToString() & "'"
        TableBySql(sSql, dtLockDetails, IResult)

        If dtLockDetails.Rows.Count = 0 Then
            sSql2 = "select ClientId, (select top 1 lName from TB_Clients where id =  ClientId) as Client_Name, (select top 1 AccountStatus from TB_Clients where id =  ClientId) as Ac_Status from TB_InwardBLS where BlNo = '" & Me.txtBLNumber.Text.ToString() & "'"
            ...
            If Not dtLockDetailsBL.Rows.Count = 0 Then
                ...
                Else
                    MessageBox.Show("Client Account is not a Bad Account", "Shipping ILS", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
                End If
    ...
    Private Sub btnStatusLock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStatusLock.Click
        ...
        If exist = False Then
            Cmd = New SqlCommand("SP_LockStatus_Insert")
        ...
        Else
            Cmd = New SqlCommand("SP_LockStatus_Update")
            Cnn = New SqlConnection(My.Settings.DSN)
            Cnn.Open()
            Cmd.CommandTimeout = 2000
            Cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub FrmClientStatusLock_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
