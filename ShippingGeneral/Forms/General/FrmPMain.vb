...
Public Class FrmPMain
    ...
    Private Sub ExplorerBar_ItemClick(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinExplorerBar.ItemEventArgs) Handles ExplorerBar.ItemClick
        ...
        Select Case e.Item.Key
            ...
            Case "GenerateVocherExp"
                OpenChaild(FrmNosaGenerateVCExp)
            Case "AccountTitle"
            ...
            Case "MAMovementsFCS"
                OpenChaild(FrmMAMovementFCS)
            Case "DamageBoxCost"
                OpenChaild(FrmDamageBoxCost)
            ...
            Case "Collection Report"
                OpenChaild(FrmCollectionReport)
            Case "TAP Detention Entry"
                OpenChaild(FrmTAPDetentionChrg)
            Case "PermitSplit"                  'PermitSplit
                OpenChaild(FrmPermitSplitOutward)
            Case "GeneralDOReport"              'General D/O report - ECS
                OpenChaild(FrmECSGeneralDOReport)
            Case "Booking Report"              'General D/O report - ECS
                OpenChaild(FrmBookingReport)
            Case Else
