...
Public Class FrmInwardPackageDetails

    Private DM As DataManager
    Private Sof As TB_SOF
    Private TBMaster As DataTable
    Private Voy As TB_Voyage
    Private Sub FrmInwardPackageDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub MenuItem_CustomPickupClick() Handles MenuItem.CustomPickupClick
        ...
        Prm = New SqlClient.SqlParameter("Voyage", SqlDbType.Char, 36, ParameterDirection.Input)
        Prm.Value = Me.Voyage.VoyageID.ToString
        arrayParams.Add(Prm)

       
        DM = New DataManager(My.Settings.DSN)
        Ds = DM.ExecuteProcedure("SP_InwardPackageDetails", CType(arrayParams.ToArray(GetType(SqlParameter)), SqlParameter()))
        ...
        Else
            ...
            With Me.GridFrieght.DisplayLayout.Bands(0)
                .HeaderVisible = True
                .Header.Activated = True
                .Header.Caption = "Package Details For " & Me.Vessel.VesselName & " " & Me.Voyage.CmbVoyage.Text
                .Header.Appearance.BackColor = Color.Maroon
                .Header.Appearance.ForeColor = Color.Yellow
                .Header.Appearance.FontData.Name = "Verdana"
                .Header.Appearance.FontData.Italic = Infragistics.Win.DefaultableBoolean.True
