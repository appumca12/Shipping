...
Public Class frmBarcodeIssuedBls
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Barcode Updated Bls" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        Cmd = New SqlCommand("SP_BarcodeIssuedBls")
        ...
        Try
            Me.GridSummary.DisplayLayout.Bands(0).Columns("Line").Hidden = True
            Me.GridSummary.DisplayLayout.Bands(0).Columns("Id").Hidden = True
    ...
    'End Sub
    Private Sub frmExportInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
