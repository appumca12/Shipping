...
Public Class FrmoutwardGenaralListDate
    ...
    Private Sub GenGnrlBySaild()
        ...
        Ds = StoredProcedures.SP_OutwardGeneralListBySailed(Me.dFrom.DateValue, Me.DTo.DateValue, CurrentShippingLine)
        If Ds.Tables(0).Rows.Count = 0 Then
            MsgBox("No any data !")
        Else
            Me.GridResult.DataSource = Ds.Tables(0).Copy
