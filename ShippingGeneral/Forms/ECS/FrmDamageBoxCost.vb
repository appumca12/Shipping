...
Public Class FrmDamageBoxCost
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Damage Cost Details" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        '
        With Cmd
            .CommandText = "SP_DamagecostDetails"
    ...
    'End Sub
    Private Sub FrmDamageBoxCost_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
