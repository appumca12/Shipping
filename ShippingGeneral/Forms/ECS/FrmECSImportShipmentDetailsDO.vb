...
Public Class FrmECSImportShipmentDetailsDO
    ...
    Private Sub ButtonPickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPickup.Click
        If Me.TabControl.SelectedTab.Text = "Import Shipment Details(DO)" Then
            PickupMovement()
        End If
    ...
    Private Sub PickupMovement()
        ...
        '
        With Cmd
            .CommandText = "SP_IMPORTSHIPMENTDO"
    ...
    'End Sub
    Private Sub FrmECSImportShipmentDetailsDO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub saveExcelFile(ByVal FileName As String)
        ...
        For i = 0 To DataGridView1.RowCount - 2
            ...
            For j = 0 To DataGridView1.ColumnCount - 1
                If (j = 11) Or (j = 12) Or (j = 14) Or (j = 15) Then
